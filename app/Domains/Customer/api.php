...
Route::group(['middleware' => 'auth:sanctum','prefix' => 'customer'],function (){
    ...
    Route::post('/import', [\App\Domains\Customer\Controllers\CustomerController::class, 'import']);
    Route::post('/assign/{id}', [\App\Domains\Customer\Controllers\CustomerController::class, 'assignUser']);
    Route::post('/attachments/{id}', [\App\Domains\Customer\Controllers\CustomerController::class, 'addAttachments']);
    Route::get('/export/example', [\App\Domains\Customer\Controllers\CustomerController::class, 'exportExample']);
    Route::get('/export/utilities', [\App\Domains\Customer\Controllers\CustomerController::class, 'exportUtilities']);
