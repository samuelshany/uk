...
class SubAccountsExport implements FromCollection, WithMapping, WithHeadings, WithEvents,ShouldAutoSize
{

    public function collection()
    {
        return AccountResource::collection( Account::whereRaw('LENGTH(code) > ?', [5])->orderBy('created_at','desc')->get());
    }
