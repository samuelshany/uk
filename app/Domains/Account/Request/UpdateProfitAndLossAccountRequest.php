...
class UpdateProfitAndLossAccountRequest extends FormRequest
{
    ...
    {
        return [
            'profit_loss' => 'nullable|string|max:255',
            'profit_loss_parent_id' => 'nullable|exists:accounts,id',
            'retained_earning' => 'nullable|string|max:255',
            'retained_earning_parent_id' => 'nullable|exists:accounts,id',
        ];
