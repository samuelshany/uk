...
Route::group(['middleware' => 'auth:sanctum','prefix' => 'bankAccount'],function (){
    ...
    Route::get('/export/example', [\App\Domains\BankAccount\Controllers\BankAccountController::class, 'exportExample']);
    Route::post('/import', [\App\Domains\BankAccount\Controllers\BankAccountController::class, 'import']);
});
