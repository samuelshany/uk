...
class ProjectManagementCategory extends Model implements HasMedia
{
    use HasFactory, SoftDeletes, HasFinancialPeriod, InteractsWithMedia;

    protected $table = 'project_management_categories';
    protected $fillable = [
        'name',
        'description',
        'creator_id',
    ...
    {
        return $this->hasMany(WorkClause::class, 'project_management_category_id');
    }
