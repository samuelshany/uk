...
return [
    ...
    */
    ...
    'exists' => 'القيمة فى حقل :attribute الذى تم اختيارها غير موجود',
    ...
    */
    ...
    'attributes' => [
        ...
        'account_id' => 'الحساب',
        'cashable_id' => 'حساب الدفع',
        'type' => 'النوع',
        'acquisition_date' => 'تاريخ الاستحواذ',
        'acquisition_value' => 'المبلغ عند الاستحواذ',
        'depreciation_value' => 'مبلغ الإهلاك',
        'depreciation_ratio' => 'نسبة الإهلاك',
        'depreciation_duration_type' => 'نوع مدة الاهلاك',
        'depreciation_duration_value' => 'مدة الإهلاك',
        'parent_id' => 'الأب',
        'parent_code' => 'كود الأب',
        'source_id' => 'المصدر',
        'destination_id' => 'الوٍجهَةُ',
        'assets_involved' => 'الأصول الداخلة',
